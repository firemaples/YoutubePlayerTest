...
interface YouTubePlayerListener {
    ...
    /**
     * Called every time the state of the player changes. Check [PlayerState] to see all the possible states.
     * @param state a state from [PlayerState]
     */
    fun onStateChange(youTubePlayer: YouTubePlayer, state: PlayerState)

    /**
     * Called every time the quality of the playback changes. Check [PlaybackQuality] to see all the possible values.
     * @param playbackQuality a state from [PlaybackQuality]
     */
    fun onPlaybackQualityChange(youTubePlayer: YouTubePlayer, playbackQuality: PlaybackQuality)
...
//     */
    ...
    /**
     * Called when an error occurs in the player. Check [PlayerError] to see all the possible values.
     * @param error a state from [PlayerError]
     */
    fun onError(youTubePlayer: YouTubePlayer, error: PlayerError)
